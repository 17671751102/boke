...
import {
    Form, Input,Modal, Tooltip, Icon, Select, Button, AutoComplete, message
  } from 'antd';
...
const RegistrationForm = Form.create({ name: 'register' })(WrappedRegistrationForm);
